...
`ElZoneScale` children of `StyleScale` in scene `B5_9`. Full note, with the
decoded records and where the style byte probably lives:
[docs/research/false-colour-el-zone.md](../research/false-colour-el-zone.md).
